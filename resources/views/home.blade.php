...
<section id="about-us" class="about-us">
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>We Prodive the following services with 100% quality & satisfaction</p>
        </div>
    ...
    <section id="clients" class="clients">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-2 border-0  clients-wrap border-none clearfix" data-aos="fade-up">

          @foreach ($brands as $brand)
              
          <div class="col-lg-3  col-md-4 col-6 " >
            <div class="client-logo border-0">
              <img src="{{ $brand->brand_image }}" class="img-fluid" alt="" style="height:80px">
            </div>
          </div>
          @endforeach
